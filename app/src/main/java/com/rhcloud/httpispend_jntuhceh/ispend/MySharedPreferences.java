...
public class MySharedPreferences {
    ...
    public void setStartDate(String lastDownloadTime)
    {
        SharedPreferences.Editor userLocalDatabaseEditor = mySharedPreferencesDatabase.edit();
        userLocalDatabaseEditor.putString("StartDate", lastDownloadTime);
        userLocalDatabaseEditor.commit();
    }

    public String getStartDate() {
        String lastDownloadTime = mySharedPreferencesDatabase.getString("StartDate", "2016-01-21 00:00:00");
        return  lastDownloadTime;
    }
